...
const addWindowToTile = (arg: {
    ...
    if (screen) {
        ...
        const widthTarget = (parentTile.absoluteGeometry.width - (40 * depth)) - (tile.relativeGeometry.width * rootWidth)
        const heightTarget = (parentTile.absoluteGeometry.height - (40 * depth)) - (tile.relativeGeometry.height * rootHeight)
